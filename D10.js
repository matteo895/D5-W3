...
let eliminazione = onlyLetters("i have 4 dogs");
...
function movies(numeroFilm) {
  return movies.length;
}
const numeroFilm = movies(numeroFilm);
...
function onlyTheYears(movies) {
  ...
  for (let title of movies) {
    anniUscita.push(title.Year.getFullYear());
  }
  return anniUscita;
}
...
let contenuto = document.getElementById("container");
